...
Lulu（噜噜）住在桌面右下角。它会看书、打瞌睡、挥手，也会在你忙到深夜时提醒休息。打开旁边的工作窗口，就能让它翻译一段话、整理一份文件、按要点写封邮件，或记下明天要做的事。
...
| --- | --- | --- |
| macOS · Apple 芯片 / Intel | `Lulu-1.0-macos.zip` | `Lulu-1.0-en-macos.zip` |
| Windows 10/11 · 64 位 | `Lulu-1.0-windows.zip` | `Lulu-1.0-en-windows.zip` |
...
处理任务时，Lulu 会思考、敲键盘；完成时说“搞定啦”，需要你补充时也会有对应动作。平时可以拖动它、让它陪你看书。天气开场动画会随城市的晴、雨、阴变化；城市自动按 IP 查找，也可以手动选择。
...
1.0 是 Lulu 的第一个公开版本。截至 2026-09-09，项目记录的验证范围如下：
...
| 自动化 | 178 项回归测试在 Ubuntu、Windows、macOS CI 上通过；Godot 脚本另有语法和语义检查。 |
